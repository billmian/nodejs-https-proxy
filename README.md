...
<img width="300" src="./imgs/google根证书.jpg" />
<img width="300" src="./imgs/google中级证书.jpg" />
<img width="300" src="./imgs/google证书.jpg" />
...
<img width="300" src="./imgs/自签名根证书.png" />

之后将需要代理的域名，生成证书并使用上面根证书签名。这样就可以实现伪造了请求域名的服务器证书。（这个服务器证书不需要导入系统钥匙串中）

<img width="300" src="./imgs/自签名证书.png" />
